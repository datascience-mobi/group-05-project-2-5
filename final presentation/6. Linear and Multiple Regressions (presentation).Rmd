...
[1. PREPARATION OF THE DATA](#anchor1)

[2. SIMPLE LINEAR REGRESSION WITH 100 BIOMARKERS: Drug sensitivity with copynumber of 100 biomarkers](#anchor2)

* [2.1. Predicting the fittness of the model](#anchor3)

* [2.2. Linear Regression](#anchor4)
       
* [2.3. Visualization of regression](#anchor5)

[3. MULTIPLE REGRESSION WITH 100 BIOMARKERS: Drug sensitivity with doubling time and copynumber of 100 biomarkers](#anchor6)

* [3.1. Predicting the fittness of the model](#anchor7)

* [3.2. Linear Regression](#anchor8)
...
par(mfrow=c(2, 2))
boxplot(lm_tab2$Drug_Sensitivity, 
        main="Drug sensitivity") 
boxplot(lm_tab2$Copynumber_100_biomarkers, 
        main="Copynumber") 


plot(density(lm_tab2$Drug_Sensitivity), 
     main="Density Plot: Drug Sensitivity", 
     ylab="Frequency", 
     sub=paste("Skewness:", round(e1071::skewness(lm_tab2$Drug_Sensitivity), 2))
    )

polygon(density(lm_tab2$Drug_Sensitivity), col="royalblue1")

plot(density(lm_tab2$Copynumber_100_biomarkers), 
     main="Density Plot: Copynumber", 
     ylab="Frequency", 
     sub=paste("Skewness:", round(e1071::skewness(lm_tab2$Copynumber_100_biomarkers), 2))
    )

polygon(density(lm_tab2$Copynumber_100_biomarkers), col="skyblue1")
