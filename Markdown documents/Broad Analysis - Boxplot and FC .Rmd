...
main= "Changes in gene expression by treatment with 15 anticancer durgs", xlab="sampels", ylab="mean Fold Change values")
...
#print(xtable::xtable(largest10_FC_all_min, caption = "10 smallest FC values 2"),type="html",html.table.attributes="border=0")
