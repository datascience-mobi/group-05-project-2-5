...
In these graphs, we can observe the behaviour of 3 cell lines under a linear regression model. 
...
Skewness of the plot on the left: -0.07 -> Plot is very slightly skewed to the left.
