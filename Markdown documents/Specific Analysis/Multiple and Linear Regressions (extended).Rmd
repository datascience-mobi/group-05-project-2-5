...
* [11.3. Linear Regression with genes with the highest and lowest mean values for copynumber](#anchor40)
       ...
       + [11.3.1.  3 top mean values for Copynumber](#anchor41)
       
       + [11.3.2. 3 lowest mean values for copynumber](#anchor42)
...
-------------------------------------------------------------------------------------------------
| Test                                                         | R-squared      | p-value        |
| ------------------------------------------------------------ | -------------  | -------------- |
| Drug sensitivity vs Doubling time                            | Content cell 2 | Content cell 2 |
| Drug sensitivity vs Copy (biomarkers)                        | Content colu 2 | Content cell 2 |
| Drug sensitivity vs Copynumber (all genes)                   | Content cell 2 | Content cell 2 |
| Drug sensitivity vs Copynumber (all genes) and Doubling time | Content cell 2 | Content cell 2 |
| PCA                                                          | Content cell 2 | Content cell 2 |
| Drug sensitivity vs Doubling time (no outliers)              | Content cell 2 | Content cell 2 |
| Top Biomarker 1: DHRS1                                       | Content cell 2 | Content cell 2 |
| Top Biomarker 2: ABAT                                        | Content cell 2 | Content cell 2 |
| Top Biomarker 3: SERPINI1                                    | Content cell 2 | Content cell 2 |
| 1. Highest Copynumber: DAZ2                                  | Content cell 2 | Content cell 2 |
| 2. Highest Copynumber: UTY                                   | Content cell 2 | Content cell 2 |
| 3. Highest Copynumber: DAZ1                                  | Content cell 2 | Content cell 2 |
| 1. Lowest Copynumber: RBM18                                  | Content cell 2 | Content cell 2 |
| 2. Lowest Copynumber: MIR3974                                | Content cell 2 | Content cell 2 |
| 3. Lowest Copynumber: SKP1P2                                 | Content cell 2 | Content cell 2 |
-------------------------------------------------------------------------------------------------
