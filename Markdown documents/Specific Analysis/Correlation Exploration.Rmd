...
We can see that creating the annotation, different genes belong to different clusters.
...
Cell lines can be observed on the y-axis on the right side, and biomarkers can be observed on the x-axis on the bottom. 
